...
class DownloadExample extends StatefulWidget {
  ...
  const DownloadExample(this.title, this.platform);

  @override
  _DownloadExampleState createState() => new _DownloadExampleState();
}
...
class _DownloadExampleState extends State<DownloadExample> {
  final _documents = [
    ...
    {
      "name": "phocapdf-demo.pdf",
      "link": "http://www.phoca.cz/demo/phocadownload/phocapdf-demo.pdf"
    }
  ];
  final _images = [
    {
      "name": "1.jpg",
      "link": "https://uploadstatic.mihoyo.com/contentweb/20191115/2019111515510150417.jpg"
    },
    {
      "name": "2.jpg",
      "link": "https://uploadstatic.mihoyo.com/contentweb/20191114/2019111412071786695.jpg"
    },
  ];
  final _videos = [
    {
      "name": "test.mp4",
      "link": "https://nico-android-apk.oss-cn-beijing.aliyuncs.com/landscape.mp4"
    },
  ];
